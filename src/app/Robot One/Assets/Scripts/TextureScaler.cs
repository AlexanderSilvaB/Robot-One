...
{
    public static Texture2D ScaledSoftware(Texture2D source,int targetWidth,int targetHeight) 
	{
    ...
    public static Texture2D ScaleDefault(Texture2D source, int newWidth, int newHeight)
	{
