// migo.cpp : Defines the exported functions for the DLL application.
//
...
extern_c int connectMigo(char *address)
{
	if (s != NULL)
		return 1;
...
extern_c float versionMigo()
{
	return VERSION;
}

extern_c float waitMigo()
{
